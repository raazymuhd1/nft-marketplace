                    ...
                    <aside className="border-[1px] p-[10px] radius flex-row-center gap-[20px] justify-between h-[200px]">
                       <div className="h-full bg-secondary radius w-[30%]">
                            ...
                            <label
                                ...
                                className="flex justify-center items-center translate-y-[-30px] h-full w-full text-center p-[10px] cursor-pointer radius"
                                    htmlFor="img-file"> 
                                    <FaPlus size={35} /> 
                            </label>
                       </div>
                       ...
                       <div className="w-[60%] h-full flex flex-col justify-center">
                            ...
                            <label
                                ...
                                className="block w-[150px] border-textBlue border-[1px] py-[5px] px-[10px] cursor-pointer radius text-center text-textBlue font-semibold"
