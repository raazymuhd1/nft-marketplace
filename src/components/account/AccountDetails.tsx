  ...
  return (
    <div className="flex flex-col w-full gap-[20px] mt-[20px]">
        <div className="flex flex-col gap-[10px]">
            ...
            <input type="text" name="" id="" placeholder='username' className="p-[10px] border-[1px] outline-none radius" />
         ...
         <div className="flex flex-col gap-[10px]">
            ...
            <textarea rows={10} placeholder='description' className="p-[10px] border-[1px] outline-none radius" />
        ...
        <div className="w-full flex flex-col gap-[10px]">
            ...
            <aside className="w-full flex-row-center gap-[10px]">
                <input type="text" name="" id="" placeholder='username' className="p-[10px] border-[1px] outline-none radius w-[90%]" />
